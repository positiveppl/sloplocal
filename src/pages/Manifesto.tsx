...
export default function Manifesto() {
  return (
    <div className="manifesto-wrap">
      ...
      <p>This is a collective — a board where anyone can drop what they built, and everyone votes on what's good. Things built fast, built local, built by people who aren't precious about "vibe coding" being a dirty word, but who still made something genuinely useful, free, and made with care. That includes civic tools, hyperlocal projects, and apps that serve a community of ten as much as a community of ten thousand. Local means local. Not because a trend told them to ship, but because they wanted to solve their own problem, raise a real issue, serve their community, or make something fun, and AI helped them do it faster.</p>
      <p>Some of us learned what a "git push" was three months ago. Some of us ran <code>git init</code> from our home directory and accidentally versioned 657 gigabytes of our entire life. Some of us approved a diff that was 4,000 lines because the app finally worked. Some of us googled "what is a pull request" at midnight while deploying our first app and called it shipping.</p>
