...
export const BUILT_WITH_OPTIONS = ['Codex', 'Claude', 'Cursor', 'v0', 'Replit', 'Lovable', 'Bolt', 'GPT-4', 'civic', 'local', 'hyperlocal', 'community', 'Other'];
...
let demoSlops: Slop[] = [
  { id: '1', slug: 'posterpress', name: 'PosterPress', url: 'https://example.com', tagline: 'Browser poster maker for flyers, shows, and neighborhood chaos.', description: 'PosterPress is a free browser-based poster studio for quick flyers and community announcements. Drag type around, layer shapes, and export something useful without opening a heavy design app.', category_slug: 'creative', built_with: ['Claude', 'Canvas API'], screenshot_url: null, vote_count: 312, status: 'approved', created_at: ago(30), submitter_id: 'demo-acedout', builder_username: 'acedout' },
